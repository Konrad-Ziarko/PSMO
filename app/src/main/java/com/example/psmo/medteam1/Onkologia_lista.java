...
public class Onkologia_lista extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_onkologia_lista);
        ...
        recList.addOnItemTouchListener(new RecyclerItemClickListener(this, new RecyclerItemClickListener.OnItemClickListener(){
            ...
            public void onItemClick(View v, int position) {
                ...
                Intent myIntent = new Intent(Onkologia_lista.this, Secondary_activity.class);
                myIntent.putExtra("key", position);
                Onkologia_lista.this.startActivity(myIntent);
            }
        }));
    }
